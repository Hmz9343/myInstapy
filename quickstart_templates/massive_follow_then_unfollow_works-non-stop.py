...
# get a session!
session = InstaPy(username='nthallroom54@gmail.com', password='Shweta@1999')
...
with smart_run(session):
    ...
    session.like_by_tags(['BeautyBlog','MakeupOfTheDay','MakeupByMe','MakeupLife','MakeupTutorial','InstaMakeup','MakeupLover','Cosmetics','BeautyBasics','MakeupJunkie','InstaBeauty','MOTD','WakeUpAndMakeup','MakeupGuru','BeautyGuru','BeautyProducts','ILoveMakeup','MakeupMafia','NaturalBeauty','OrganicBeauty'], amount=8000)
    #'BeautyBlog','MakeupOfTheDay','MakeupByMe','MakeupLife','MakeupTutorial','InstaMakeup','MakeupLover','Cosmetics','BeautyBasics','MakeupJunkie','InstaBeauty','MOTD','WakeUpAndMakeup','MakeupGuru','BeautyGuru','BeautyProducts','ILoveMakeup','MakeupMafia','NaturalBeauty','OrganicBeauty'
